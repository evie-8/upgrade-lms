    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="border-grey bg-white" align="end">
        ...
        <ConfirmAction onConfirm={onDelete}>
          <button
            className="flex items-start justify-center rounded-sm px-2 py-1.5 hover:text-destructive cursor-pointer text-sm outline-none transition-color data-[disabled]:pointer-events-none data-[disabled]:opacity-50"
            disabled={isLoading}
          >
