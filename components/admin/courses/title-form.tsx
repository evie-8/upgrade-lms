...
const TitleForm: React.FC<Props> = ({data}) => {
    ...
    <div className="mt-6  bg-primary/10 rounded-md p-4">
       <div className="font-semibold  flex items-center justify-between">
       ...
       </div>
        {
                    ...
                    <FormField
                        ...
                        render={({field}) => (
                            <FormItem>
                                 ...
                                 <FormControl>
                                    <Input {...field} placeholder='e.g Front-End Development' className='focus-visible:outline-primary bg-white border-transparent' disabled={pending}/>
                                </FormControl>
                            <FormMessage/>
            ...
            <p className="text-sm mt-2 font-normal">{data.name}</p>
        }
    </div>
  )
}
