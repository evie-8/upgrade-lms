...
const ReviewCreation = ({courseId, reviews}: {courseId: string, reviews: Review | null}) => {
  ...
  return (
    ...
    <div>
        ...
        <p className='mx-5 text-primary font-semibold'>{rating !== null && ratingMeaning[rating - 1]}</p>
                ...
                <textarea value={review} onChange={(e)=> setReview(e.target.value)} placeholder="Write a review" className="border border-grey rounded-lg outline-none my-2 p-4 w-full"></textarea>
