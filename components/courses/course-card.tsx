    ...
    <div className="course-item">
      ...
      <div className="content">
        ...
        <p className="course-title">
          <Link href={`/courses/${id}/details`}>{name}</Link>
        </p>
      ...
      <div className="course-pay">
        <p
          className={`${
            cost !== "Free" ? "text-lg  whitespace-nowrap" : "text-xl"
          } `}
        >
          {cost}
        </p>
        {user && !purchase && cost !== "Free" && (
          <button onClick={onClick} disabled={isLoading} className="link">
            {" "}
            {status == "Open" ? "Enroll" : ""}
          </button>
        )}
...
const CourseCardList: React.FC<Props> = ({
  status,
  level,
  category,
  name,
  ...
  return (
    <div className="course-item-list ">
      ...
      <div className="content flex-grow">
        ...
        <p className="course-title whitespace-nowrap">
          <Link href={`/courses/${id}/details`}>{name}</Link>
        </p>
        <div className="icon-wrapper">
          <p>
        ...
        <div className="course-pay">
          <p
            className={`${
              cost !== "Free" ? "text-[16px]  whitespace-nowrap" : "text-xl"
            } `}
          >
            {cost}
          </p>
