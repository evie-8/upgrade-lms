...
const NewPasword = () => {
  ...
  return (
    ...
    <AuthCard headerLabel="Reset Password" 
        ...
        <Form {...form}>
                    ...
                    <FormField 
                     ...
                     <button className="w-full h-12 outline-none rounded-md text-base  font-semibold mb-7 border-2 border-transparent bg-primary text-white hover:bg-opacity-90 transition-all ease-out duration-[0.3s]" disabled={pending}>{pending ? <BeatLoader />: 'Change password'}</button>
                    </form>
