    ...
    <>
      <div className="w-full h-auto flex items-center gap-7">
        <div className="w-1/2 h-auto">
          <button
            className="w-full h-12 p-4 outline-none border font-semibold rounded-md flex items-center justify-center gap-x-2 bg-primary text-white border-transparent ease-out duration-[0.3s] hover:bg-opacity-90"
      ...
      <div className="w-full h-auto flex items-center gap-x-1 my-5">
        <div className="w-1/2 h-[1px] bg-grey rounded-md" />
        <p className="text-sm text-gray font-normal px-2">OR</p>
        <div className="w-1/2 h-[1px] bg-grey rounded-md" />
      </div>
    </>
  );
