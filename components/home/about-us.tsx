...
const AboutUs = () => {
  return (
    <section>
         <div className="courses-banner" style={{width:'100%', backgroundRepeat:'no-repeat', backgroundSize:'cover',  backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(images/about-us.jpg)`, backgroundPosition: 'center'}}>
        <Container>
