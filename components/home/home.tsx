      ...
      <Container>
        <div className="hero">
          <div className="grid-1">
            ...
            <p>
              Explore a world of dynamic online classes. Elevate your skills and
              expand your horizons from anywhere.
            </p>
          ...
          <div className="hero-facts-grid">
            <div className="contents">
              <p className="icon border-purple bg-purple/10">
                <FontAwesomeIcon
                  icon={faBusinessTime}
                  className="text-purple w-7 h-7"
                />
              </p>
              <div className="facts">
                <p>Full Lifetime Access</p>
                <p>
                  Unlock a Lifetime of Learning: Forever Access to Enrichment
                </p>
              </div>
            </div>
            ...
            <div className="contents">
              <p className="icon border-light-green bg-light-green/10 ">
                <FontAwesomeIcon
                  ...
                  className="text-light-green w-7 h-7"
                />
              </p>
              <div className="facts">
                <p>400+ Courses Available</p>
                <p>
                  Dive into Diversity: Over 400 Courses to Fuel Your Passion
                </p>
              </div>
            </div>
      ...
      <div className="reviews">
        <Container>
          <div className="heading my-7">
            ...
            <p>
              Unlock firsthand experiences as our students share their
              transformative journey with our courses
            </p>
          </div>
